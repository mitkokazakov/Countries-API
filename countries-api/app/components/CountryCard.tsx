...
const CountryCard = ({name,population,region,capital,flag}: CountryParams) => {
  ...
  return (
    <div className='flex flex-col rounded-lg shadow-md overflow-hidden md:h-[360px]'>
      <img className='md:h-full lg:w-full lg:max-h-[160px] lg:min-h-[160px]' src={flag} alt="" />
